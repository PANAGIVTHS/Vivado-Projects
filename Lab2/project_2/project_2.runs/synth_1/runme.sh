...
HD_PWD='C:/Users/panag/Desktop/GitHub/Repositories/Vivado-Code/Lab2/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sender.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sender.tcl
