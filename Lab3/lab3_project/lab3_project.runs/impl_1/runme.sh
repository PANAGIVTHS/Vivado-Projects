...
HD_PWD='C:/Users/panag/Desktop/GitHub/Repositories/Vivado-Code/Lab3/lab3_project/lab3_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA.tcl -notrace
