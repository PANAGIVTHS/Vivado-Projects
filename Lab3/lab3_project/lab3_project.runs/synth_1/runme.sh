...
HD_PWD='C:/Users/panag/Desktop/GitHub/Repositories/Vivado-Code/Lab3/lab3_project/lab3_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VRAM.tcl
